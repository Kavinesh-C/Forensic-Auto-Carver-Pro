...
_log_path = os.path.join(project_home, 'wsgi_import_errors.log')
...
try:
    ...
    try:
        _info_path = os.path.join(project_home, 'run_imported_app_file.log')
    ...
    try:
        _loaded_log = os.path.join(project_home, 'wsgi_loaded.log')
